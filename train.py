...
style_images = glob.glob('styles/wave.jpg')
print(style_images)
...
X_data = []
image_size = 256
paths = glob.glob('train2014/result/*.jpg')
...
OUTPUT_DIR = 'outputs_%s' % style_name
...
for e in range(epochs):
    ...
    #plt.imshow(result)
    #plt.show()
    imsave(os.path.join(OUTPUT_DIR, 'output_%d.jpg' % e), result)
